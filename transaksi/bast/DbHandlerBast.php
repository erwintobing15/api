...
/**
 * All database handler method for Berita Acara Serah Terima (BAST) data
 * author       : Erwin Tobing
 * created      : 09 Jan 2021 14:37 pm
 * modified     : 
 */
...
class DbHandlerBast
{
    ...
    public function allBast($id)
    {
        $sql = "SELECT * FROM tbl_bast ORDER BY id_surat DESC";
    ...
    public function oneBast($id) 
    {
        $sql = "SELECT * FROM tbl_bast WHERE id_surat = '".$id."'";
        $result = $this->conn->query($sql);
        if ($result->num_rows > 0) {
            header('Content-Type: application/json');
            $data = array();
    ...
    public function insertBast($no_agenda,$no_surat,$tujuan,$isi,$tgl_surat,
    ...
    public function updateBast($id,$no_agenda,$no_surat,$tujuan,$isi,
                    $tgl_surat,$tgl_catat,$keterangan,$file,$file_temp) 
    {
        $sqlcek = "SELECT * FROM tbl_bast WHERE id_surat = '".$id."'";
    ...
    {   
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "DELETE FROM tbl_bast WHERE id_surat = '".$id."'";
            $this->conn->query($sql);
