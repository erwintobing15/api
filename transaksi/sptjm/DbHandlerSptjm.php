...
/**
 * All database handler method for Surat Pernyataan Tanggung Jawab Mutlak (SPTJM) data
 * author       : Erwin Tobing
 * created      : 09 Jan 2021 14:26 pm
 * modified     : 
 */

class DbHandlerSptjm
{
    ...
    public function allSptjm($id)
    {
        $sql = "SELECT * FROM tbl_sptjm ORDER BY id_surat DESC";
    ...
    public function oneSptjm($id) 
    {
        $sql = "SELECT * FROM tbl_sptjm WHERE id_surat = '".$id."'";
        $result = $this->conn->query($sql);
        if ($result->num_rows > 0) {
            header('Content-Type: application/json');
            $data = array();
    ...
    public function insertSptjm($no_agenda,$no_surat,$tujuan,$isi,$tgl_surat,
    ...
    public function updateSptjm($id,$no_agenda,$no_surat,$tujuan,$isi,
                    $tgl_surat,$tgl_catat,$keterangan,$file,$file_temp) 
    {
        $sqlcek = "SELECT * FROM tbl_sptjm WHERE id_surat = '".$id."'";
    ...
    public function deleteSptjm($id)
    {   
        $sqlcek = "SELECT * FROM tbl_sptjm WHERE id_surat = '".$id."'";
        $result = $this->conn->query($sqlcek);    
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "DELETE FROM tbl_sptjm WHERE id_surat = '".$id."'";
            $this->conn->query($sql);
