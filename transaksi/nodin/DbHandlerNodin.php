...
/**
 * All database handler method for transaksi surat keputusan (Nodin) data
 * author       : Erwin Tobing
 * created      : 09 Jan 2021 10:38 am
 * modified     : 
 */

class DbHandlerNodin
{
    ...
    public function allNodin($id)
    {
        $sql = "SELECT * FROM tbl_nodin ORDER BY id_surat DESC";
    ...
    public function oneNodin($id) 
    {
        $sql = "SELECT * FROM tbl_nodin WHERE id_surat = '".$id."'";
        $result = $this->conn->query($sql);
        if ($result->num_rows > 0) {
            header('Content-Type: application/json');
            $data = array();
    ...
    public function insertNodin($no_agenda,$no_surat,$tujuan,$isi,$tgl_surat,
    ...
    public function updateNodin($id,$no_agenda,$no_surat,$tujuan,$isi,
                    $tgl_surat,$tgl_catat,$keterangan,$file,$file_temp) 
    {
        $sqlcek = "SELECT * FROM tbl_nodin WHERE id_surat = '".$id."'";
    ...
    {   
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "DELETE FROM tbl_nodin WHERE id_surat = '".$id."'";
            $this->conn->query($sql);
